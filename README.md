...
3) Build the image in local -> docker build -t monster123159/shopfront:latest .

docker build -t monster123159/productcatalogue:latest .

docker build -t monster123159/stockmanager:latest .

4) Push the image to your docker hub -> docker push monster123159/shopfront:latest 

docker push monster123159/productcatalogue:latest

docker push monster123159/stockmanager:latest
